function loadMNIST(callback) {
  let mnist = {};
  let files = {
    train_images: 'lib/mnist/train-images.idx3-ubyte',
    train_labels: 'lib/mnist/train-labels.idx1-ubyte',
    test_images: 'lib/mnist/t10k-images.idx3-ubyte',
    test_labels: 'lib/mnist/t10k-labels.idx1-ubyte',
  };
